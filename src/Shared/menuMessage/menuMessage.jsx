...
export function MessageMenu({ menu, setReactions }){
    if(!menu) return null;
  return (
    <>
  <ul className={styles.moreMenu} >
      ...
      <li onClick={setReactions}><MdOutlineEmojiEmotions  color="rgb(117, 117, 117)"  size ="20" style={{marginRight:"4px"}}/> <span>Реакция</span></li>
      </ul>
    </>
  )
